...
def getPathFromLeafPort(
    ip=None, token=None, cookies=None, name=None, port=None, fex=None
):
...
def getEPGsFromPath(
    ip=None, token=None, cookies=None, leaf_path=None, port=None, fex=None
):
    ...
    if response_code == 200:
        response = r.json()
        cookies = r.cookies
        if "children" not in response["imdata"][0]["l1PhysIf"]:
            return 0, []
        try:
            objects = response["imdata"][0]["l1PhysIf"]["children"][0][
                "pconsCtrlrDeployCtx"
            ]["children"]
...
def getEPGsFromInterfaceProfilePath(
    ip=None, token=None, cookies=None, interface_profile_path=None
):
    ...
    if response_code == 200:
        response = r.json()
        cookies = r.cookies
        if "children" not in response["imdata"][0]["fabricPathEp"]:
            return 0, []
        try:
            objects = []
...
def getPortCfgFromPath(
    ...
    if response_code == 200:
        ...
        cookies = r.cookies
        try:
            return response["imdata"][0]["l1PhysIf"]["children"][0][
                "ethpmPhysIf"
            ]["attributes"]
        except Exception as err:
...
def addPolicies(ip=None, token=None, cookies=None, aep=None):
    ...
    policies = {
        ...
        "Phy_Global": {
            "physDomP": {
                "attributes": {"dn": "uni/phys-Phy_Global"},
                "children": [
                    {
                        "infraRsVlanNs": {
                            "attributes": {
        ...
        "AEP_Global": {
            "infraAttEntityP": {
                "attributes": {"dn": "uni/infra/attentp-AEP_Global"},
                "children": [
                    {
                        "infraRsDomP": {
                            "attributes": {
        ...
        "SinglePort_Device": {
            "infraAccPortGrp": {
                ...
                "children": [
                    {
                        "infraRsStpIfPol": {
                            "attributes": {"tnStpIfPolName": "BPDU_Guard"}
                        }
                    },
                    {
                        "infraRsCdpIfPol": {
                            "attributes": {"tnCdpIfPolName": "CDP_On"}
                        }
                    },
                    {
                        "infraRsLldpIfPol": {
                            "attributes": {"tnLldpIfPolName": "LLDP_On"}
                        }
                    },
                    {
                        "infraRsAttEntP": {
        ...
        "SinglePort_Server": {
            "infraAccPortGrp": {
                ...
                "children": [
                    ...
                    {
                        "infraRsCdpIfPol": {
                            "attributes": {"tnCdpIfPolName": "CDP_Off"}
                        }
                    },
                    {
                        "infraRsLldpIfPol": {
                            "attributes": {"tnLldpIfPolName": "LLDP_Off"}
                        }
                    },
                    {
                        "infraRsAttEntP": {
        ...
        "SinglePort_Switch": {
            "infraAccPortGrp": {
                ...
                "children": [
                    {
                        "infraRsStpIfPol": {
                            "attributes": {"tnStpIfPolName": "BPDU_Forward"}
                        }
                    },
                    {
                        "infraRsCdpIfPol": {
    ...
    for policy_name, policy_data in policies.items():
        r = requests.post(
            url, verify=False, cookies=cookies, data=json.dumps(policy_data)
        )
        response_code = r.status_code
        response_text = r.text
        if response_code != 200:
            logging.error(
                f"failed to create application policy {policy_name} with code {response_code}"
            )
            logging.debug(response_text)
            return False
    return True
        ...
        if int(response["totalCount"]) > 0:
            for policy in response["imdata"]:
                for k, v in policy.items():
                    if name:
                        if (
                            "name" in v["attributes"]
                            and v["attributes"]["name"] == name
                        ):
                            policies.append(policy)
                    elif (
                        "name" in v["attributes"]
                        and "monPolDn" in v["attributes"]
                        and v["attributes"]["name"] != "default"
                        and v["attributes"]["monPolDn"]
...
def addAppProfile(
    ip=None, token=None, cookies=None, name=None, description=None
):
    if not ip or not token or not cookies or not name:
        logging.error("missing ip, token, cookies or name")
        return False
    ...
    payload = {"fvAp": {"attributes": {"name": name}}}
    if description:
        payload["fvAp"]["attributes"]["descr"] = description

    r = requests.post(
        url, verify=False, cookies=cookies, data=json.dumps(payload)
    )
    response_code = r.status_code
    response_text = r.text
    if response_code == 200:
        ...
        logging.error(
            f"failed to create application profile with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def getAppProfiles(ip=None, token=None, cookies=None, name=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get application profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addBD(
    ...
    if not mac:
        mac = "00:22:BD:{:02x}:{:02x}:{:02x}".format(
    ...
    payload = {
        "fvBD": {
            ...
            "children": [{"fvRsCtx": {"attributes": {"tnFvCtxName": vrf}}}],
        }
    }
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create bridge domain with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def bindBDtoL3Out(
    ip=None, token=None, cookies=None, name=None, tenant=None, l3out=None
):
    if (
        not ip
        or not token
    ...
    url = f"https://{ip}/api/node/mo/uni/tn-{tenant}/BD-{name}.json?challenge={token}"
    payload = {"fvRsBDToOut": {"attributes": {"tnL3extOutName": l3out}}}
    r = requests.post(
        url, verify=False, cookies=cookies, data=json.dumps(payload)
    )
    response_code = r.status_code
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to bind bridge domain to L3Out with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def unbindBDtoL3Out(
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to unbind bridge domain from L3Out with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def deleteBD(ip=None, token=None, cookies=None, name=None, tenant=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete bridge domain with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def getBDs(ip=None, token=None, cookies=None, tenant=None, name=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get bridge domains with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addEPG(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, name, tenant, app, bd or domain"
        )
        return False
    ...
    payload = {
        "fvAEPg": {
            "attributes": {"name": name, "pcEnfPref": "unenforced"},
            "children": [
...
def deleteEPG(
    ip=None, token=None, cookies=None, name=None, tenant=None, app=None
):
...
def getEPGs(
    ip=None, token=None, cookies=None, tenant=None, app=None, name=None
):
    if not ip or not token or not cookies or not tenant:
...
def addPathToEPG(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, path, vlan, mode, name, app or tenant"
        )
        return False
...
def deletePathFromEPG(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, name, app or tenant or path"
        )
        return False

    url = f"https://{ip}/api/node/mo/uni/tn-{tenant}/ap-{app}/epg-{name}/rspathAtt-[{path}].json?challenge={token}"
    payload = {"fvRsPathAtt": {"attributes": {"status": "deleted"}}}
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete path from EPG with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def getPathFromEPG(
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get paths from EPG with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addFexProfile(
    ...
    payload = {
        "infraFexP": {
            ...
            "children": [{"infraFexBndlGrp": {"attributes": {"name": name}}}],
        }
    }
    ...
    if description:
        ...
        payload["infraFexP"]["children"][0]["infraFexBndlGrp"]["attributes"][
            "descr"
        ] = description
...
def addInterfacePolicyGroup(
    ...
    for policy_name in policies:
        total, objects = getInterfacePolicies(
            ip=ip, token=token, cookies=cookies, name=policy_name
        )
        if total == 1:
            ...
            if policy_class_name == "LacpLagPol":
                payload[class_name]["children"].append(
                    {
                        "infraRsLacpPol": {
                            "attributes": {"tnLacpLagPolName": policy_name}
                        }
                    }
                )
            else:
...
def getInterfacePolicyGroups(
    ip=None, token=None, cookies=None, name=None, class_name=None
):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get interface policy groups with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addInterfaceProfile(
    ...
    payload = {"infraAccPortP": {"attributes": {"name": name}, "children": []}}
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create interface profile with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def deleteInterfaceProfile(ip=None, token=None, cookies=None, name=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete interface profile with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def getInterfaceProfiles(ip=None, token=None, cookies=None, name=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get interface profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False


def getInterfaceProfileFromPortAndLeaf(
    ip=None, token=None, cookies=None, port=None, leaf=None
):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get interface profiles from port with code {response_code}"
        )
        logging.debug(response_text)
        return False
    ...
    for object in objects:
        interface_profile = (
            object["infraPortBlk"]["attributes"]["dn"]
            .split("/")[2]
            .split("-")[1]
        )
        total, unused = getSwitchProfilesFromInterfaceProfile(
            ip=ip,
            token=token,
            cookies=cookies,
...
def getSwitchProfilesFromInterfaceProfile(
    ip=None, token=None, cookies=None, name=None, leaf=None
):
    if not ip or not token or not cookies or not name:
        logging.error("missing ip, token, cookies or name")
        return False, False
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get switch profile from interface profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addInterfaceSelector(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, profile, group, class_name or name"
        )
        return False
    # Classes:
    # - infraAccPortGrp per single port
    ...
    payload = {"infraHPortS": {"attributes": {"name": name}, "children": []}}
...
def getInterfaceSelectors(
    ip=None, token=None, cookies=None, name=None, profile=None
):
    if not ip or not token or not cookies:
        logging.error("missing ip, token, cookies")
        return False, False
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get interface selectors with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addInterfaceSelectorBlock(
    ...
    if fex:
        if (
            ...
            logging.error(
                "missing ip, token, cookies, profile, selector, group or name"
            )
            return False
    else:
        if (
            ...
            logging.error(
                "missing ip, token, cookies, profile, selector or name"
            )
            return False
    try:
    ...
    if fex:
        object = None
        total, policy_groups = getInterfacePolicyGroups(
            ip=ip,
            token=token,
            cookies=cookies,
            name=group,
        ...
        if description:
            payload["infraHPortS"]["children"][0]["infraPortBlk"][
                "attributes"
            ]["descr"] = description
    else:
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create interface selector block with code {response_code}"
        )
        logging.debug(response_text)
        return False


def deleteInterfaceSelectorBlock(
    ip=None,
    token=None,
    cookies=None,
    name=None,
    ...
    if fex:
        if (
            ...
            logging.error(
                "missing ip, token, cookies, profile, selector, name"
            )
            return False
    else:
        # TODO
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete interface selector block with code {response_code}"
        )
        logging.debug(response_text)
        return False


def getInterfaceSelectorBlocks(
    ip=None,
    token=None,
    cookies=None,
    name=None,
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get interface selector blocks with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addStaticL3Out(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, name, tenant, vrf or domain"
        )
        return False
    ...
    payload = {
        "l3extOut": {
            "attributes": {"name": name, "enforceRtctrl": "export"},
            "children": [
                {"l3extRsEctx": {"attributes": {"tnFvCtxName": vrf}}},
                {
                    "l3extRsL3DomAtt": {
                        "attributes": {"tDn": f"uni/l3dom-{domain}"}
                    }
                },
                {
                    "l3extInstP": {
...
def addStaticL3OutSVI(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, tenant, vlan, leaf_ip, vip_ip_address, mode, l3out, node_name, name"
        )
        return False
    ...
    if not vip_mac_address:
        vip_mac_address = "00:22:BD:{:02x}:{:02x}:{:02x}".format(
            random.randint(0, 255),  # nosec
            random.randint(0, 255),  # nosec
            random.randint(0, 255),  # nosec
        )
    ...
    if path:
        ...
        payload = {
            "l3extRsPathL3OutAtt": {
                ...
                "children": [
                    {"l3extIp": {"attributes": {"addr": vip_ip_address}}}
                ],
            }
        }
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create static L3Out SVI with code {response_code}"
        )
        logging.debug(response_text)
        return False


def getStaticL3OutSVI(
    ip=None,
    token=None,
    cookies=None,
    tenant=None,
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, tenant, l3out, node_name, interface_name"
        )
        return False, False
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get SVI from L3Out with code {response_code}"
        )
        logging.debug(response_text)
        return False, False


def addL3OutNodeProfile(
    ip=None,
    token=None,
    cookies=None,
    name=None,
    ...
    payload = {"l3extLNodeP": {"attributes": {"name": name}}}
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create L3Out node profile with code {response_code}"
        )
        logging.debug(response_text)
        return False


def deleteL3OutNodeProfile(
    ip=None, token=None, cookies=None, name=None, l3out=None, tenant=None
):
    if (
        not ip
        or not token
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete L3Out node profile with code {response_code}"
        )
        logging.debug(response_text)
        return False


def getL3OutNodeProfiles(
    ip=None, token=None, cookies=None, tenant=None, l3out=None, name=None
):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get L3Out node profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False


def addL3OutNodeInterfaceProfile(
    ip=None,
    token=None,
    cookies=None,
    name=None,
    ...
    payload = {"l3extLIfP": {"attributes": {"name": name}}}
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create L3Out node interface profile with code {response_code}"
        )
        logging.debug(response_text)
        return False


def getL3OutNodeInterfaceProfiles(
    ip=None,
    token=None,
    cookies=None,
    tenant=None,
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get L3Out node interface profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False


def addStaticL3OutConfiguredNodes(
    ip=None,
    token=None,
    cookies=None,
    tenant=None,
    ...
    payload = {
        "l3extRsNodeL3OutAtt": {
            "attributes": {"rtrId": router_id, "rtrIdLoopBack": "false"}
        }
    }
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create L3Out node configuration with code {response_code}"
        )
        logging.debug(response_text)
        return False


def getStaticL3OutConfiguredNodes(
    ip=None,
    token=None,
    cookies=None,
    tenant=None,
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get L3Out configured nodes with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addStaticRoute(
    ...
    if (
        ...
        logging.error(
            "missing ip, token, cookies, tenant, l3out, node_name, gateway"
        )
        return False
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to create static route with code {response_code}"
        )
        logging.debug(response_text)
        return False


def deleteStaticRoute(
    ip=None,
    token=None,
    cookies=None,
    tenant=None,
    ...
    payload = {
        "l3extRsNodeL3OutAtt": {
            ...
            "children": [
                {
                    "ipRouteP": {
                        "attributes": {"ip": network, "status": "deleted"}
                    }
                }
            ],
        }
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to delete static route with code {response_code}"
        )
        logging.debug(response_text)
        return False
...
def addSubnet(
    ...
    payload = {
        "fvSubnet": {
            "attributes": {"ip": name, "scope": "public", "virtual": "no"}
        }
    }
...
def deleteSubnet(
    ip=None, token=None, cookies=None, bd=None, tenant=None, name=None
):
    if not ip or not token or not cookies or not name or not tenant or not bd:
        logging.error("missing ip, token, cookies, name, tenant or bd")
        return False
...
def getSubnets(
    ip=None, token=None, cookies=None, tenant=None, bd=None, name=None
):
...
def bindSwitchProfileToInterfaceProfile(
    ip=None, token=None, cookies=None, name=None, interface_profile=None
):
    ...
    payload = {
        "infraRsAccPortP": {
            "attributes": {"tDn": f"uni/infra/accportprof-{interface_profile}"}
        }
    }
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to bind switch profile to interface profile with code {response_code}"
        )
        logging.debug(response_text)
        return False, False


def unbindSwitchProfileFromInterfaceProfile(
    ip=None, token=None, cookies=None, name=None, interface_profile=None
):
    if not ip or not token or not cookies or not name or not interface_profile:
        logging.error("missing ip, token, cookies, name or interface_profile")
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to unbind switch profile from interface profile with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def getSwitchProfiles(ip=None, token=None, cookies=None, name=None):
    ...
    if response_code == 200:
        ...
        logging.error(
            f"failed to get switch profiles with code {response_code}"
        )
        logging.debug(response_text)
        return False, False
...
def addTenant(ip=None, token=None, cookies=None, name=None, description=None):
    ...
    payload = {"fvTenant": {"attributes": {"name": name}}}
    if description:
...
def addVRF(ip=None, token=None, cookies=None, name=None, description=None):
    ...
    payload = {
        "fvCtx": {"attributes": {"name": name, "pcEnfPref": "unenforced"}}
    }
    if description:
